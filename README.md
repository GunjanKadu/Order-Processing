...
Application to demonstrate the entire flow of order processing as required by the companies to keep track of employees,orders & payments with various parts of a service oriented RESTfull application. 
...
## About
This is an RESTfull implementation of an order processing app.
